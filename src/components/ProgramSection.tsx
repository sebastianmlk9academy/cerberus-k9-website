        ...
        {resolvedCards.map((card, index) => (
          ...
          >
            ...
            <div className="h-[40px] flex items-center gap-4">
              ...
              <span 
                className="font-[family-name:var(--font-rajdhani)] text-[11px] font-bold tracking-[2.5px] text-[color:var(--card-accent)]"
              >
                {card.category}
              </span>
            </div>
            ...
            <div className="mt-auto pt-[15px]">
              <span 
                className="flex items-center h-[70px] font-[family-name:var(--font-rajdhani)] text-[11px] font-bold tracking-[2px] text-[#C42B2B] px-3 py-2 bg-[rgba(196,43,43,0.15)] border border-[rgba(196,43,43,0.35)] leading-relaxed"
              >
                {card.badge}
              </span>
            </div>
